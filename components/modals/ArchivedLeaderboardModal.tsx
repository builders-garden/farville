...
// Current week: 7 January - 12 January 2026 (the final week)
// Previous week: 31 December 2025 - 6 January 2026
const FINAL_WEEK_LABEL = "Jan 7 - Jan 12, 2026 (Final Week)";
const PREVIOUS_WEEK_LABEL = "Dec 31, 2025 - Jan 6, 2026";

interface ArchivedLeaderboardModalProps {
  onClose: () => void;
  initialTab?: "weekly" | "global" | "friends";
}

export default function ArchivedLeaderboardModal({
  onClose,
  initialTab = "weekly",
}: ArchivedLeaderboardModalProps) {
                  ...
                  <div className="flex gap-2 xs:gap-3">
                    {[
                      ...
                      <motion.button
                        ...
                        className={`px-2 xs:px-3 rounded-full flex items-center justify-center gap-1 xs:gap-1.5 transition-all duration-200 text-[10px] xs:text-xs
                          ${
              ...
              {activeTab === "weekly" && (
                <>
                  <Card className="bg-[#5c4121] text-white/90 border-none mb-2">
                    <CardContent className="flex flex-col gap-2 xs:gap-4 p-3">
                      <div className="flex flex-row items-center gap-2 xs:gap-3">
                        <Image
                          ...
                          width={48}
                          height={60}
                          className="w-12 h-15 xs:w-16 xs:h-20 hidden xs:block"
                        />
                        <div className="flex flex-col w-full gap-3">
                          <div className="flex flex-col gap-0.5 xs:gap-1.5 w-full">
                            <div className="flex flex-row w-full justify-between items-center">
                              ...
                              <button
                                className="w-fit text-[7px] xs:text-[8px] px-1.5 xs:px-2 py-0.5 xs:py-1 rounded-full bg-white/10 hover:bg-white/20 
                          ...
                          {/* Fixed archived date display instead of countdown */}
                          <div className="bg-[#6d4c2c]/80 rounded-lg p-1 flex items-center justify-between">
                            ...
                            <div className="text-white font-medium text-[8px] xs:text-[9px]">
                              {isShowingCurrentWeek
                                ? FINAL_WEEK_LABEL
                                : PREVIOUS_WEEK_LABEL}
                            </div>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex flex-col gap-0.5 xs:gap-1 w-full">
                      ...
                      <div className="flex items-center gap-2 xs:gap-4">
                        {activeTab === "weekly" || leaderboardType === "xp" ? (
                          <>
                            {activeTab !== "weekly" && (
