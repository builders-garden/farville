    ...
    >
      ...
      <div className="relative z-20 flex flex-col gap-2 w-full max-w-md p-4">
        ...
        <div className="flex gap-2 mt-4">
          <div className="w-1/3 bg-black/30 backdrop-blur-sm rounded-lg p-2">
            <h3 className="text-white/70 text-xs mb-2">Total Players</h3>
            <p className="text-white text-xl font-bold">
              {gameStats.totalUsers}
            </p>
          </div>
          <div className="w-1/3 bg-black/30 backdrop-blur-sm rounded-lg p-2">
            <h3 className="text-white/70 text-xs mb-2">Total Referrals</h3>
            <p className="text-white text-xl font-bold">
              {gameStats.totalReferrals}
            </p>
          </div>
          <div className="w-1/3 bg-black/30 backdrop-blur-sm rounded-lg p-2">
            <h3 className="text-white/70 text-xs mb-2">Users last week</h3>
            <p className="text-white text-xl font-bold">
              {gameStats.totalUsersLastWeek}
            </p>
          </div>
        </div>

        <div className="flex flex-col gap-2 mt-4">
          <h2 className="text-white/90 text-lg font-bold [text-shadow:_2px_2px_4px_rgb(0_0_0_/_50%)]">
            Top Referrers
          </h2>
