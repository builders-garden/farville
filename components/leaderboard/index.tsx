                ...
                {activeTab === "weekly" && (
                  <>
                            ...
                            <div className="bg-[#6d4c2c]/80 rounded-lg p-1 flex items-center justify-between">
                              ...
                              <div className="flex gap-1 text-white font-bold">
                                <div className="bg-[#5c4121] px-1 py-0.5 rounded text-[9px] min-w-[20px] text-center">
                                  {timeUntilNextWeek.days
                                    .toString()
                                    .padStart(2, "0")}
                                  <span className="text-[#FFB938] ml-0.5">
                                    d
                                  </span>
                                </div>
                                <div className="bg-[#5c4121] px-1 py-0.5 rounded text-[9px] min-w-[20px] text-center">
                    ...
                    <LeaderboardPrizeCard
                      leagueType={leagueType as 1 | 2 | 3}
                      isModalOpen={isLeagueInfoModalOpen}
                      onModalToggle={setIsLeagueInfoModalOpen}
                    />
                  </>
                )}
                {!(
