...
export default function ClanJoinRequests({
  ...
  return (
    <>
      {isAtCapacity && (
        <div className="flex items-center gap-4 p-3 text-xs bg-yellow-950/30 border-b border-[#8B5E3C]/40 rounded-lg">
          <TriangleAlert className="h-24 w-24 text-yellow-400" />
          <span className="text-yellow-400/90">
            Your clan is at maximum capacity. You cannot accept new members
            until a space becomes available.
          </span>
        </div>
      )}

      <div className="bg-[#6D4C2C]/80 rounded-md mt-3 mb-8">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  disabled={
                    processingRequests[request.id]?.processing || isAtCapacity
                  }
                  size="sm"
